# AGENTS.md - shaper-sim

This repo has project-specific agent instructions in `AGENT.md`. Read that file before changing simulator code, physics logic, tests, or docs.

## Global Memory Bootstrap

The reusable memory-system bootstrap guide lives at:

`C:\Users\Beetroot\.agents\docs\AI_MEMORY_STACK_BOOTSTRAP.md`

Use that guide when installing or repairing the Memory Bank + Graphify + llm-wiki style setup in any repo. Merge its contracts into existing project files; do not replace repo-specific state.
